...
class ModernToolbar(QWidget):
    ...
    def initUI(self):
        ...
        self.setFixedHeight(620) # Alttan biraz daha uzatıldı
        self.setStyleSheet("""
        ...
        # İç boşluklar ve butonlar arası mesafe artırıldı
        layout = QVBoxLayout(self)
        layout.setContentsMargins(10, 15, 10, 15) 
        layout.setSpacing(9) # Butonlar arasına eşit ve ferah boşluk
        ...
        # Boyut Kontrolü (Görünürlük ve Hizalama Düzenlendi)
        size_box = QFrame()
